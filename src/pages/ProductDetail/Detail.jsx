                    ...
                    <div className='md:flex gap-20'>
                        <div className='flex w-3/5 gap-8'>
                            <div className='md:grid grid-cols-1 md:w-1/4 gap-y-2.5 hidden'>
                                <div className='border-2 border-slate-500 rounded'>
                                    <img src="https://hanoicomputercdn.com/media/product/37583_gamepad_sony_ps4_dualshock4_wireless_controller_xanh_chinhhang_0001_1.jpg" alt="" />
                                </div>
                                <div className='border-2 border-slate-500 rounded'>
                                    <img src="https://hanoicomputercdn.com/media/product/37583_gamepad_sony_ps4_dualshock4_wireless_controller_xanh_chinhhang_0001_1.jpg" alt="" />
                                </div>
                        ...
                        <div className='md:w-2/5'>
                            <div className='flex flex-col gap-y-4'>
                                ...
                                <div className='text-sm font-semibold py-2'>PlayStation 5 Controller Skin High quality vinyl with air channel adhesive for easy bubble free install & mess free removal Pressure sensitive.</div>
                                ...
                                <div className='flex gap-8 items-center'>
                                    <div>Size: </div>
                                    <div className='flex gap-4'>
                                        {size.map((e, i) => (<div className='px-2 py-1 border border-black rounded' key={i}>{e}</div>))}
                                    </div>
                                </div>
                                <div className='flex md:gap-10 gap-0 md:gap-y-2 '>
                                    <div className='w-2/4 flex'>
                                        <button className='border border-slate-400 text-xl h-full flex items-center justify-center w-1/4'>-</button>
                                        <div className='border border-slate-400 px-4 h-full flex items-center justify-center w-2/4'>2</div>
                                        <button className='bg-red-500 text-white h-full flex items-center justify-center w-1/4'>+</button>
                                    </div>
                                    <div className='bg-red-600 text-white py-2.5 px-8 text-sm rounded w-max'>Buy Now</div>
                                    <div className='border border-black flex items-center px-2.5 sm:w-max'><HeartOutlined /></div>
                                </div>
                                <div className='w-full flex flex-col justify-center '>
                                    <div className='border border-black p-4 flex items-center gap-4'>
                                        ...
                                        <div>
                                            ...
                                            <div className='font-semibold text-xs'>Enter your postal code for Delivery Availability</div>
                                        </div>
                                    </div>
                                    <div className='border border-black p-4 flex items-center gap-4'>
                        ...
                        <div className='grid grid-cols-2 md:grid-cols-4 gap-10'>
                            <div className='flex flex-col gap-y-2 relative'>
                                <div className='p-2 bg-slate-200'>
                                    ...
                                    <div className='absolute right-[15px] mt-2 px-2.5 py-1 border border-black '><HeartOutlined /></div>
                                    <img src="https://salt.tikicdn.com/ts/tmp/52/93/88/61ff58b8b3596ff29718c6aaa84d29b8.jpg" alt="" />
                                </div>
                                <div>
