                ...
                <div className='md:flex flex-col gap-y-20'>
                    ...
                    <div className='md:flex gap-20'>
                        <div className='flex w-3/5 justify-between'>
                            <div className='md:grid grid-cols-2 md:w-2/4 gap-y-2.5 hidden '
                            // style={{ display: "flex" }}
                            >
                                {productDetail.default_image && (
                                    <div className='flex justify-center items-center h-full border-2 rounded'
                                        style={{ width: 180 }}
                                        onClick={() => setMainImage(productDetail.default_image)}
                                    >
                                        <img
                            ...
                            <div className='flex flex-col gap-y-4'>
                                ...
                                <div className='flex gap-4'>
                                    <div className='flex gap-2.5 items-center'>
                                        ...
                                        <div className='text-sm'>{listComment.length} reviews</div>
                                    </div>
                                ...
                                <div className='flex md:gap-10 gap-0 md:gap-y-2 '>
                                    ...
                                    <div
                                        ...
                                        className='bg-red-600 text-white py-2.5 px-8 text-sm rounded text-center w-1/2'>Buy Now</div>
                        ...
                        <div className='border border-slate-200 p-4 rounded-lg space-y-4'>
                            {listComment.map((review, index) => (
                                <div key={index} className='space-y-2'>
                                    ...
                                    <div className='text-sm text-slate-600'>{review.content}</div>
